...
public class TestPortRange extends FTPTestCase {
     ...
     * Revision control id
     */
    public static String cvsId = "@(#)$Id: TestPortRange.java,v 1.3 2005/10/10 20:54:16 hans Exp $";
    ...
    public void testTransferBinary() throws Exception {
        ...
        if (!((FTPClient)ftp).getConnectMode().equals(FTPConnectMode.ACTIVE))
            throw new Exception("Test only valid for ACTIVE mode");
        
        ((FTPClient)ftp).setActivePortRange(lowPort, highPort);
